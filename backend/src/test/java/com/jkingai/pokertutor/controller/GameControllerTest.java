...
@TestPropertySource(properties = {
        // Effectively disable per-IP game-creation throttling for these tests;
        // GameCreationRateLimitTest covers the throttle in isolation.
        "app.limits.games-created-per-hour-per-ip=1000"
})
